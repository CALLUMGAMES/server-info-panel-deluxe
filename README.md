...
2. Copy the `Server_Panel_Deluxe` and  `Server_Panel_Deluxe(Custom Settings)` folders to your:
   ```
   7DaysToDie/Mods/
   ```
...
 - aswell as A SPEICAL THANKS TO BPMVT FOR UPDATING THE UI AND IMAGING    
...
Development of new mods and features
Professional assets and software
Ongoing maintenance and updates
Server and testing costs
Where possible, a portion of donations will also be contributed to charitable causes.
Thank you for supporting  CG MODS AKA ( CALLUMGAMES ) and the 7 Days to Die community.
